...
set_target_properties(TKCDF PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKCDF.a"
  )

list(APPEND _cmake_import_check_targets TKCDF )
list(APPEND _cmake_import_check_files_for_TKCDF "${_IMPORT_PREFIX}/lib/libTKCDF.a" )
...
set_target_properties(TKLCAF PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKLCAF.a"
  )

list(APPEND _cmake_import_check_targets TKLCAF )
list(APPEND _cmake_import_check_files_for_TKLCAF "${_IMPORT_PREFIX}/lib/libTKLCAF.a" )
...
set_target_properties(TKCAF PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKCAF.a"
  )

list(APPEND _cmake_import_check_targets TKCAF )
list(APPEND _cmake_import_check_files_for_TKCAF "${_IMPORT_PREFIX}/lib/libTKCAF.a" )
...
set_target_properties(TKBinL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinL.a"
  )

list(APPEND _cmake_import_check_targets TKBinL )
list(APPEND _cmake_import_check_files_for_TKBinL "${_IMPORT_PREFIX}/lib/libTKBinL.a" )
...
set_target_properties(TKXmlL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlL.a"
  )

list(APPEND _cmake_import_check_targets TKXmlL )
list(APPEND _cmake_import_check_files_for_TKXmlL "${_IMPORT_PREFIX}/lib/libTKXmlL.a" )
...
set_target_properties(TKBin PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBin.a"
  )

list(APPEND _cmake_import_check_targets TKBin )
list(APPEND _cmake_import_check_files_for_TKBin "${_IMPORT_PREFIX}/lib/libTKBin.a" )
...
set_target_properties(TKXml PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXml.a"
  )

list(APPEND _cmake_import_check_targets TKXml )
list(APPEND _cmake_import_check_files_for_TKXml "${_IMPORT_PREFIX}/lib/libTKXml.a" )
...
set_target_properties(TKStdL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKStdL.a"
  )

list(APPEND _cmake_import_check_targets TKStdL )
list(APPEND _cmake_import_check_files_for_TKStdL "${_IMPORT_PREFIX}/lib/libTKStdL.a" )
...
set_target_properties(TKStd PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKStd.a"
  )

list(APPEND _cmake_import_check_targets TKStd )
list(APPEND _cmake_import_check_files_for_TKStd "${_IMPORT_PREFIX}/lib/libTKStd.a" )
...
set_target_properties(TKTObj PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKTObj.a"
  )

list(APPEND _cmake_import_check_targets TKTObj )
list(APPEND _cmake_import_check_files_for_TKTObj "${_IMPORT_PREFIX}/lib/libTKTObj.a" )
...
set_target_properties(TKBinTObj PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinTObj.a"
  )

list(APPEND _cmake_import_check_targets TKBinTObj )
list(APPEND _cmake_import_check_files_for_TKBinTObj "${_IMPORT_PREFIX}/lib/libTKBinTObj.a" )
...
set_target_properties(TKXmlTObj PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlTObj.a"
  )

list(APPEND _cmake_import_check_targets TKXmlTObj )
list(APPEND _cmake_import_check_files_for_TKXmlTObj "${_IMPORT_PREFIX}/lib/libTKXmlTObj.a" )
...
set_target_properties(TKVCAF PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKVCAF.a"
  )

list(APPEND _cmake_import_check_targets TKVCAF )
list(APPEND _cmake_import_check_files_for_TKVCAF "${_IMPORT_PREFIX}/lib/libTKVCAF.a" )
